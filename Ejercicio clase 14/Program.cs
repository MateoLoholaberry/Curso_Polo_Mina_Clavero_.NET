...
using Ejercicio_clase_14.Modelos;
...
Console.WriteLine("cartas afuera ahora:");
baraja1.CartasMonton();
Console.WriteLine();

Console.WriteLine("sacamos otra carta");
baraja1.siguienteCarta();
...
Console.WriteLine();
Console.WriteLine("sacamos varias cartas:");
baraja1.DarCartas(5);

Console.WriteLine();
Console.WriteLine("Baraja ahora:");
Console.WriteLine();
